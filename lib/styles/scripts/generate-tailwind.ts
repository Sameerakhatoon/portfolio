...
@theme {
  ...
  --spacing-*: initial;
	/* Tailwind v4 dynamic scale - sets a base unit so p-4, gap-6, mt-8,
	   etc. all resolve via calc(var(--spacing) * N). Without this, generic
	   utilities like gap-4/py-8 silently render as 0. */
	--spacing: 0.25rem;
	--spacing-0: 0;
	/* Common fixed-size half-step tokens for completeness */
	--spacing-px: 1px;
