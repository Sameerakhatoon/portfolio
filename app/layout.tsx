...
const APP_NAME = 'Sameera Khatoon'
const APP_DEFAULT_TITLE = 'Sameera Khatoon - Software Engineer'
const APP_TITLE_TEMPLATE = '%s - Sameera Khatoon'
const APP_DESCRIPTION =
  'Portfolio of Sameera Khatoon - Software Engineer building distributed systems, microservices, and full-stack applications. NIT Warangal.'
const APP_BASE_URL =
  process.env.NEXT_PUBLIC_BASE_URL ?? 'https://sameerakhatoon.me'
...
export const metadata: Metadata = {
  ...
  authors: [{ name: 'Sameera Khatoon', url: 'https://sameerakhatoon.me' }],
  other: {
